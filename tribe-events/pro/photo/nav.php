...
<ul class="tribe-events-sub-nav">
	...
	<li class="tribe-events-nav-previous"><a href="#" class="tribe_paged gray clear button left"><?php _e( '<span>&laquo;</span> Previous Events', 'tribe-events-calendar-pro' ) ?></a></li>
	...
	<?php endif; ?>
	>
		<a href="#" class="tribe_paged gray clear button right"><?php _e( 'Next Events <span>&raquo;</span>', 'tribe-events-calendar-pro' ) ?></a>
