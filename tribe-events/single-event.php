...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<?php the_title( '<h1 class="underline tribe-events-single-event-title summary">', '</h1>' ); ?>
    ...
    <div id="tribe-events-footer">
		...
		<ul class="tribe-events-sub-nav">
			<li class="tribe-events-nav-previous"><?php tribe_the_prev_event_link( '&laquo; Previous Event' ) ?></li>
			<li class="tribe-events-nav-next"><?php tribe_the_next_event_link( 'Next Event &raquo;' ) ?></li>
