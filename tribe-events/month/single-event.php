...
$month = tribe_get_start_date( $event = null, $displayTime = false, $dateFormat = 'M' ); // this string can be anything
$day = tribe_get_start_date( $event = null, $displayTime = false, $dateFormat = 'd' );
$post_thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id(), 'tooltip-thumb');
$url = $post_thumbnail[0];
$additional_data['month'] = $month;
$additional_data['day'] = $day;
$additional_data['thumbUrl'] = $url; 
